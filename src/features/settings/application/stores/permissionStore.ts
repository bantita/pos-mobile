...
export const usePermissionStore = create<PermissionState>()(
  ...
  canAccessScreen: (role, screenKey) => {
    ...
    const { DEFAULT_SCREEN_PERMISSIONS } = require('@/features/settings/domain/rolePermissions');
  ...
  setScreensForRole: (role, screens) => {
    ...
    const { setCustomPermissions } = require('@/features/settings/domain/rolePermissions');
