...
import { Promotion, CouponUsage, AppliedDiscount, PromoType } from '@/features/promotion/domain/promotion';
import { MOCK_PROMOTIONS, MOCK_COUPON_USAGES } from '@/features/promotion/data/mocks/mockPromotions';
...
export const usePromoStore = create<PromoStore>()(
  ...
  couponUsages: MOCK_COUPON_USAGES,
