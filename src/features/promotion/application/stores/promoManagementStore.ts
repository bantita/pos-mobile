...
import { ProductGroupPromotion } from '@/features/promotion/domain/productGroupPromo';
import { BundlePromotion } from '@/features/promotion/domain/bundlePromo';
import { QuantityPromotion } from '@/features/promotion/domain/quantityPromo';
...
export const usePromoManagementStore = create<PromoManagementStore>()(
  ...
  getActiveCountByCategory: () => {
    ...
    let memberCount = 0;
    try {
      const { MOCK_MEMBER_PROMOTIONS } = require('@/features/promotion/data/mocks/mockMemberPromotions');
