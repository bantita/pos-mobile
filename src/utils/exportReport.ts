...
const PDF_STYLES = `
  body { font-family: 'Sarabun', Arial, sans-serif; margin: 20px; color: #2A1A0E; font-size: 12px; }
  h1 { color: #FF8F8F; font-size: 20px; margin-bottom: 4px; }
  h2 { color: #FF8F8F; font-size: 14px; }
  .meta { color: #7D6B5A; font-size: 11px; margin-bottom: 16px; }
  table { width: 100%; border-collapse: collapse; margin-top: 12px; }
  th { background: #FFF1CB; color: #2A1A0E; padding: 8px 10px; text-align: left; border: 1px solid #EAE0D8; font-size: 11px; }
  td { padding: 7px 10px; border: 1px solid #EAE0D8; font-size: 11px; }
  tr:nth-child(even) td { background: #FAF9F7; }
  .total-row td { background: #FFF1CB; font-weight: bold; }
  .badge-green { color: #2E7D4F; font-weight: bold; }
  .badge-red   { color: #B91C1C; font-weight: bold; }
  .badge-warn  { color: #D4891A; font-weight: bold; }
  .footer { margin-top: 24px; color: #A89F96; font-size: 10px; text-align: right; }
