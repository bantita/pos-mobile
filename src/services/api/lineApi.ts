  ...
  return {
    ...
    contents: {
      ...
      header: {
        ...
        layout: 'vertical',
        contents: [
          { type: 'text', text: '🎫 คูปองส่วนลด', weight: 'bold', size: 'md', color: '#FF6B6B' },
          { type: 'text', text: params.shopName, size: 'xs', color: '#aaaaaa' },
        ],
        paddingAll: '16px',
      ...
      body: {
        ...
        layout: 'vertical',
        contents: [
          { type: 'text', text: params.discount, weight: 'bold', size: 'xxl', color: '#FF6B6B', align: 'center' },
          { type: 'text', text: params.description || 'ใช้ได้ทุกรายการ', size: 'sm', color: '#666666', align: 'center', margin: 'md' },
          { type: 'separator', margin: 'lg' },
          {
            type: 'box', layout: 'horizontal', margin: 'lg', contents: [
              { type: 'text', text: 'รหัส:', size: 'sm', color: '#999999', flex: 1 },
              { type: 'text', text: params.couponCode, size: 'sm', weight: 'bold', color: '#333333', flex: 2 },
            ],
          },
          {
            type: 'box', layout: 'horizontal', margin: 'sm', contents: [
              { type: 'text', text: 'หมดอายุ:', size: 'sm', color: '#999999', flex: 1 },
              { type: 'text', text: params.expiryDate, size: 'sm', color: '#FF6B6B', flex: 2 },
            ],
          },
        ],
        paddingAll: '16px',
  ...
  return {
    ...
    contents: {
      ...
      body: {
        ...
        layout: 'vertical',
        contents: [
          { type: 'text', text: `⭐ +${params.pointsEarned} คะแนน`, weight: 'bold', size: 'lg', color: '#F5A623' },
          { type: 'text', text: `สวัสดีคุณ ${params.memberName}`, size: 'sm', color: '#666666', margin: 'sm' },
          { type: 'separator', margin: 'lg' },
          {
            type: 'box', layout: 'horizontal', margin: 'lg', contents: [
              { type: 'text', text: 'คะแนนรวม:', size: 'sm', color: '#999999' },
              { type: 'text', text: `${params.totalPoints.toLocaleString()} pts`, size: 'sm', weight: 'bold', align: 'end' },
            ],
          },
          {
            type: 'box', layout: 'horizontal', margin: 'sm', contents: [
              { type: 'text', text: 'ระดับ:', size: 'sm', color: '#999999' },
              { type: 'text', text: params.level, size: 'sm', weight: 'bold', align: 'end', color: '#F5A623' },
            ],
          },
        ],
        paddingAll: '16px',
