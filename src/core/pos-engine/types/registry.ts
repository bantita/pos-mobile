...
import { ConditionConfig, BenefitConfig } from '@/core/pos-engine/types/inputs';
import { EvaluationContext, ConditionResult, BenefitContext, BenefitResult } from '@/core/pos-engine/types/internal';
