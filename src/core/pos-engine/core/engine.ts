...
import { CalculationResult, AppliedBenefit, PointTransaction } from '@/core/pos-engine/types/outputs';
import { EvaluatedPromotion, EvaluationContext, BenefitResult, RedeemResult, PaymentResult } from '@/core/pos-engine/types/internal';
import { PromotionType } from '@/core/pos-engine/types/enums';
import { validateInput } from '@/core/pos-engine/validators/index';
import { filterActivePromotions } from '@/core/pos-engine/core/filter';
import { buildFinalTotals } from '@/core/pos-engine/core/subtotal';
import { createConditionRegistry, evaluateAllConditions } from '@/core/pos-engine/conditions/index';
import { createBenefitRegistry, applyAllBenefits } from '@/core/pos-engine/benefits/index';
import { resolveConflicts } from '@/core/pos-engine/conflict/index';
import { calculateEarnPoints } from '@/core/pos-engine/points/earning';
import { processRedemption } from '@/core/pos-engine/points/redemption';
import { processPointPayment } from '@/core/pos-engine/points/payment';
import { shouldProcessPoints } from '@/core/pos-engine/points/policyEnforcer';
import { AuditTrailBuilder } from '@/core/pos-engine/audit/trailBuilder';
...
export function calculate(request: CalculationRequest): CalculationResult {
  ...
  const context: EvaluationContext = {
    ...
    memberSegments: request.memberSegments,
