import { PromotionConfig, PointPolicy } from '../types/inputs';
import { EarnResult } from '../types/internal';
import { PointTransaction, FreeGift } from '../types/outputs';
import { PointType, PointPolicyMode, PromotionType } from '../types/enums';
